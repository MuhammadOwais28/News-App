class NewsModel {
  ...
  NewsModel({this.status, this.copyright, this.response});
...
class Docs {
  ...
  Docs.fromJson(Map<String, dynamic> json) {
    ...
    keywords = json["keywords"] == null
        ? null
        : (json["keywords"] as List).map((e) => Keywords.fromJson(e)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["print_section"] = printSection;
    _data["print_page"] = printPage;
    _data["source"] = source;
    if (multimedia != null) {
...
class Byline {
  ...
  Byline.fromJson(Map<String, dynamic> json) {
    ...
    person = json["person"] == null
        ? null
        : (json["person"] as List).map((e) => Person.fromJson(e)).toList();
